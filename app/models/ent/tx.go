...
func (tx *Tx) init() {
	...
	tx.SecondFactorCode = NewSecondFactorCodeClient(tx.config)
	tx.User = NewUserClient(tx.config)
	tx.UserAction = NewUserActionClient(tx.config)
	tx.UserDetails = NewUserDetailsClient(tx.config)
...
// applies a query, for example: ActivationCode.QueryXXX(), the query will be executed
